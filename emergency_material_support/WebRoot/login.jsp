    ...
    <div class="container">
        <div class="row align-items-center py-5">
            ...
            <div class="col-lg-5 px-lg-4">
                <h2 class="text-base text-primary text-uppercase mb-4">应急物资管理系统</h2>
                <p class="text-muted">欢迎使用应急物资管理系统后台管理系统</p>
        ...
        <p class="mt-5 mb-0 text-gray-400 text-center">Copyright &copy; 应急物资管理系统</p>
    </div>
</div>
<!-- JavaScript files-->
